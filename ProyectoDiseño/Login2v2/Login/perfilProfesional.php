                    ...
                    <div class="row col-md-8 row-2-perfilEmpresa card-mod">
                        ...
                        <div class="col-md-12 mb-3 ">
                            ...
                            <select class="form-control form-select" id="carreraProfesional">
                                ...
                                <option value="Cine, Televisión">Cine, Televisión</option>
                                <option value="Comercio Exterior, Negocios Internacionales">Comercio Exterior, Negocios Internacionales</option>
                                ...
                                <option value="Literatura, Lingüística">Literatura, Lingüística</option>
                                ...
                                <option value="Matemáticas, Estadística">Matemáticas, Estadística</option>
                                ...
                                <option value="Teología y afines">Teología</option>
